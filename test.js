...
var browserController = {
  ...
  detailController = {
    state: {
      baseUrl: "http://christmas.rogue.studio/share",
      hash: {},
      dehash: {},
      gridItem: null,
      timeout: null,
    ...
    initPage: function (e, t) {
      ...
      e
        ...
        e.getElementsByClassName("facebookButton")[0].addEventListener(
          "click",
          detailController.socialLink.bind({
            platform: "facebook",
          })
        ),
        e.getElementsByClassName("twitterButton")[0].addEventListener(
          "click",
          detailController.socialLink.bind({
            platform: "twitter",
          })
        ),
        e.getElementsByClassName("emailButton")[0].addEventListener(
          "click",
          detailController.socialLink.bind({
            platform: "email",
          })
    ...
    generateLink: function () {
      ...
      return (
        ...
        detailController.state.baseUrl + t
      );
    },
    ...
    previewLink: function () {
      ...
      event("share", "preview", "click", !0), window.open(e, "_blank");
    },
    copyLink: function () {
      ...
      switch (this.platform) {
        ...
        case "twitter":
          event("share", "twitter", "click", !0),
            openURLInPopup(
              (t = makeTw("Have a Weird Christmas!", "christmas", e)),
              600,
              400
            );
          break;
        case "email":
          event("share", "email", "click", !0);
          var t = makeEmail(
            "Have a Weird Christmas!",
            "Hi!\n\nI made a weird Christmas card just for you! Check it out:\n\n" +
              e +
              "\n\nHave a Weird Christmas!!\n\nFrom " +
              detailController.state.data.reduce(function (e, t) {
                if ("f" == t.name) return t.value;
              }, "")
          );
          openMailLink(t);
      }
  ...
  soundArray = [
    ...
    ["/sounds/shuffle-in.mp3", "shuffle-in", null],
    ["/sounds/shuffle-out.mp3", "shuffle-out", null],
    ["/sounds/whoosh.mp3", "whoosh", null],
    ["/sounds/pop.mp3", "pop", null],
  ],
  cardArray = [
    ["bad-santa", "bs"],
    ["root-veg", "rv"],
...
var gridController = {
  ...
  createImage: function (e, t) {
    var r = "/images/cards-min/" + e + "@",
      n = document.createElement("picture");
    n.classList.add(t);
    var o = document.createElement("source");
    o.setAttribute("srcset", r + "2x.webp 2x, " + r + "1x.webp 1x"),
      o.setAttribute("type", "image/webp"),
      n.append(o);
    var i = document.createElement("source");
    i.setAttribute("srcset", r + "2x.jpg 2x, " + r + "1x.jpg 1x"),
      i.setAttribute("type", "image/jpeg"),
      n.append(i);
    var a = document.createElement("img");
    return (
      a.setAttribute("src", r + "1x.jpg"),
      ...
      switch (e) {
        ...
        case "twitter":
          event("share-share", "twitter", "click", !0),
            openURLInPopup(
              (r = makeTw("Have a Weird Christmas!", "christmas", t)),
              600,
              400
            );
          break;
        case "email":
          event("share-share", "email", "click", !0);
          var r = makeEmail(
            "Have a Weird Christmas!",
            "Check out this weird Christmas card I just got from " +
              shareController.state.data.f +
              ":\n\n" +
              t +
              "\n\nHave a Weird Christmas!!"
          );
...
function makeEmail(e, t) {
  var r = "mailto:?",
    n = !1;
  return (
    "" !== e &&
      ((r += (n ? "&" : "") + "subject=" + amperoctoplus(encodeURI(e))),
      (n = !0)),
    "" !== t &&
      ((r += (n ? "&" : "") + "body=" + amperoctoplus(encodeURI(t))), (n = !0)),
    r
  );
}
